...
{
    public class FastSalesContext : DbContext
    {

        public FastSalesContext()
        {

        }
        public FastSalesContext(DbContextOptionsBuilder builder) : base(builder.Options) { }
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            optionsBuilder.UseSqlServer(@"Server=.;Database=FastSalesDB;Integrated Security=true");
        }
