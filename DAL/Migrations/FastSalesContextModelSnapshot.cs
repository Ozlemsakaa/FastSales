...
{
    [DbContext(typeof(FastSalesContext))]
    partial class FastSalesContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Model.AccountDefinition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<double?>("CreatedAmount")
                        .HasColumnType("float");
                    ...
                    b.ToTable("AccountDefinition");
                });

            modelBuilder.Entity("DAL.Model.AccountTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<short?>("AccountTransactionTypeId")
                        .HasColumnType("smallint");
                    ...
                    b.Property<double?>("CreditorAmount")
                        .HasColumnType("float");
                    ...
                    b.Property<int?>("CustomerTransferId")
                        .HasColumnType("int");

                    b.Property<DateTime?>("DeletedDate")
                        .HasColumnType("datetime2");

                    b.Property<double?>("DeptAmount")
                        .HasColumnType("float");
                    ...
                    b.Property<int?>("OutgoingsCategoryId")
                        .HasColumnType("int");

                    b.Property<int?>("OutgoingsEntryId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("PersonelTransactionId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.Model.AccountTransactionType", b =>
                {
                    b.Property<short>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint")
                    ...
                    b.ToTable("AccountTransactionType");
                });

            modelBuilder.Entity("DAL.Model.AccountType", b =>
                {
                    b.Property<short>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint")
            ...
            modelBuilder.Entity("DAL.Model.ReturnOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DAL.Model.ReturnOrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DAL.Model.AccountDefinition", b =>
                {
                    b.HasOne("DAL.Model.AccountType", "AccountType")
                        .WithMany()
            ...
            modelBuilder.Entity("DAL.Model.AccountTransaction", b =>
                {
                    b.HasOne("DAL.Model.AccountDefinition", "AccountDefinition")
                        .WithMany()
                        .HasForeignKey("AccountDefinitionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DAL.Model.AccountTransactionType", "AccountTransactionType")
                        .WithMany()
                    ...
                    b.HasOne("DAL.Model.Currency", "CurrencyType")
                        .WithMany()
            ...
            modelBuilder.Entity("DAL.Model.OrderDetailAttribute", b =>
                {
                    ...
                    b.HasOne("DAL.Model.ReturnOrderDetail", null)
                        .WithMany("OrderDetailAttributes")
            ...
            modelBuilder.Entity("DAL.Model.ReturnOrderDetail", b =>
                {
                    ...
                    b.HasOne("DAL.Model.ReturnOrder", "ReturnOrder")
                        .WithMany("OrderDetails")
